                                 ...
                                 sidebarLayout(
                                   ...
                                   mainPanel(
                                     ...
                                     HTML('The choropleth map below represents, for the item/year selected, the relative value of each country in the world context. The relative position of the counterpart economy was defined in terms of quartiles:
                                          <li style=margin-left:2em>    <strong>Very High </strong> (<strong><span style = color:rgb(35,132,67)>dark green colour</span></strong>) - country has very high values when compared with the other countries; top 25% of the world (fourth quartile); </li>
                                          <li style=margin-left:2em>   <strong> High </strong> (<strong><span style = color:rgb(120,198,121)>green colour</span></strong>) - country has high values when compared to other countries; between top 50% and top 25% of the world (third quartile); </li>
                                          <li style=margin-left:2em>     <strong> Medium </strong> (<strong><span style = color:rgb(194,230,153)>light green colour</span></strong>) - country has medium values when compared to other countries; between bottom 25% and bottom 50% of the world (second quartile); </li>
                                          <li style=margin-left:2em>       <strong> Low </strong> (<strong><span style = color:rgb(227,194,145)>yellow colour</span></strong>) - country has low values when compared with the other countries; bottom 25% of the world (first quartile). </li>
                                          '),
