                          ...
                          plotlyOutput("distPlot", width = "100%", height="350px"),br(), HTML('<span style = color:rgb(128,128,128)>Data source: Banco de Portugal, April 2019 <a href="https://www.bportugal.pt/EstatisticasWeb/(S(iczvpy45y4bm4r45n2n55045))/DEFAULT.ASPX?Lang=en-GB">Click here</a> <div>Methodological source: Balance of Payments and International Investment Position Manual, Sixth Edition (BPM 6), 2009 <a href="https://www.imf.org/external/pubs/ft/bop/2007/pdf/bpm6.pdf">Click here</a></span></div>')
                                 ...
                                 sidebarLayout(
                                   ...
                                   mainPanel(
                                     ...
                                     HTML('The choropleth map below represents, for the item/year selected, the relative value of each country in the world context. The relative position of the counterpart economy was defined in terms of quartiles:
                                          <li style=margin-left:2em>    <strong>High </strong> (<strong><span style = color:rgb(35,132,67)>dark green colour</span></strong>) - country has relatively higher values when compared with the other countries; top 25% of the world (fourth quartile); </li>
                                          <li style=margin-left:2em>   <strong> Medium </strong> (<strong><span style = color:rgb(120,198,121)>green colour</span></strong>) - country has a relatively middle-high value when compared to other countries; between top 50% and top 25% of the world (third quartile); </li>
                                          <li style=margin-left:2em>     <strong> Low </strong> (<strong><span style = color:rgb(194,230,153)>light green colour</span></strong>) - country has a relatively middle-low value when compared to other countries; between bottom 25% and bottom 50% of the world (second quartile); </li>
                                          <li style=margin-left:2em>       <strong>Very low </strong> (<strong><span style = color:rgb(227,194,145)>yellow colour</span></strong>) - country has relatively lower values when compared with the other countries; bottom 25% of the world (first quartile). </li>
                                          '),
                      ...
                      sidebarLayout(
                        sidebarPanel(
                          ...
                          selectInput('heatmapvariable','Select an item in the select box:',
                                      c("Current and capital account (Balance)","Goods (Balance)","Services (Balance)",
                                        "Current and capital account (Credit)","Goods (Exports)","Services (Exports)","Current and capital account (Debit)", "Goods (Imports)","Services (Imports)"))
                          #        ,br(),br(),br(),
                          #           HTML("<p align=right><font size=3><span style= color:rgb(142,0,0)><strong>Did you know that...</strong></font></span>
                          #               <br><br><em><font size=2><span style= color:rgb(72,72,72)>
                        ...
                        mainPanel( 
                          ...
                          plotlyOutput("heatmap", width = "100%", height="400px"),br(), HTML('<span style = color:rgb(128,128,128)>Data source: Banco de Portugal, April 2019 <a href="https://www.bportugal.pt/EstatisticasWeb/(S(iczvpy45y4bm4r45n2n55045))/DEFAULT.ASPX?Lang=en-GB">Click here</a> <div>Methodological source: Balance of Payments and International Investment Position Manual, Sixth Edition (BPM 6), 2009 <a href="https://www.imf.org/external/pubs/ft/bop/2007/pdf/bpm6.pdf">Click here</a></span></div>')
                      ...
                      sidebarLayout(
                        ...
                        mainPanel(   
                          ...
                          HTML('The scatterplot chart below shows the evolution of exports/imports by type of service. 
                               The <strong><span style= color:rgb(142,0,0)>red line</span></strong> represents the bissectrice; 
                               when the bubble (service) is below the line, the service under analysis has, for the chosen year, 
                               exports greater than the imports (and vice-versa). You can find more about the services by moving the mouse over the bubble (<strong>tooltips</strong>).
                               <br>  <br>      
                      ...
                      sidebarLayout(
                        ...
                        mainPanel(HTML('<center><span style= color:rgb(142,0,0)><font face=Calibri size=6> Current account balance per European country (% GDP*, three year average) </center> </font></span>')
                                  ,HTML("The current account balance is one of the indicators used by the European Commission to access macroeconomic imbalances; '<em>any trend giving rise to macroeconomic developments which are adversely affecting, or have the potential to adversely affect, the proper functioning of the economy</em>'.
                                        <br><br>In the graph below it is possible to compare the Portuguese economy (<span style = color:rgb(142,0,0)><strong>red bar</strong></span>) with other European countries. <div>  You can find more about the values of each country by moving the mouse over the bars in the bar chart (<strong>tooltips</strong>). </div>
                                        "),br(),br(),br(),
...
server <- function(input, output) {
  ...
  colourPalette <- (brewer.pal(9,'RdYlGn'))
  ...
  output$bubles <-   renderPlotly({
    ...
    my_colors <- c("#808080","#808080","#808080","#808080","#808080","#808080","#808080","#808080","#808080","#808080","#3399ff","#ff0066")
    other_colors <- c("#000000","#ff0000","#ffc000","#ffff00","#92d050","#00b050","#00b0f0","#0070c0","#002060","#7030a0")
  ...
  output$international <-   renderPlotly({
    ...
    x <- c('BEL','BGR','CHE','DNK','DEU','EST','IRL','GRC','ESP','FRA','HRV','ITA','CYP','LVA','LTU','LUX','HUN','MLT','NLD','AUT','POL','PRT','ROU','SVN','SVK','FIN','SWE','GBR')
    ...
    if((input$internationaldates=="2018")&(input$rd=="All European countries")){
      ...
      plot_ly(MIP_Y2018, x=~Country, y=~GDP, type = 'bar', name = 'GDP',
              marker = list(color=c('rgb(227,194,145)','rgb(227,194,145)','rgb(227,194,145)','rgb(227,194,145)','rgb(227,194,145)',
                                    'rgb(227,194,145)','rgb(227,194,145)','rgb(227,194,145)','rgb(227,194,145)','rgb(227,194,145)',
                                    'rgb(227,194,145)','rgb(227,194,145)','rgb(227,194,145)','rgb(227,194,145)','rgb(227,194,145)',
                                    'rgb(227,194,145)','rgb(227,194,145)','rgb(227,194,145)','rgb(227,194,145)','rgb(227,194,145)',
                                    'rgb(227,194,145)','rgb(142,0,0)','rgb(227,194,145)','rgb(227,194,145)','rgb(227,194,145)',
                                    'rgb(227,194,145)','rgb(227,194,145)','rgb(227,194,145)')))%>%
      ...
      plot_ly(MIP_Y2018_P, x=~Country, y=~GDP, type = 'bar', name = 'GDP',
              marker = list(color=c('rgb(227,194,145)',
                                    'rgb(227,194,145)','rgb(227,194,145)','rgb(142,0,0)')))%>%
      ...
      plot_ly(MIP_Y2018_04, x=~Country, y=~GDP, type = 'bar', name = 'GDP',
              marker = list(color=c('rgb(227,194,145)',
                                    'rgb(227,194,145)','rgb(227,194,145)','rgb(227,194,145)','rgb(227,194,145)','rgb(227,194,145)','rgb(227,194,145)','rgb(227,194,145)','rgb(227,194,145)','rgb(227,194,145)','rgb(142,0,0)','rgb(227,194,145)','rgb(227,194,145)','rgb(227,194,145)','rgb(227,194,145)')))%>%
